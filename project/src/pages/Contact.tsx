          ...
          <div className="container-xl">
            ...
            >
              ...
              <div className="relative z-10">
                <h2 className="text-xl font-semibold text-zinc-800 dark:text-white mb-6">Investment Inquiries</h2>
            ...
            <div className="space-y-6">
              ...
              >
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold mb-2">Sydney Office</h3>
                ...
                <div className="space-y-6">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <a href="mailto:enquiries@tasmancapital.com.au" className="hover:text-zinc-300 transition-colors">
